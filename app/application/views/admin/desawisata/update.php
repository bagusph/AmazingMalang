...
<div class="modal-body">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" name="desa" class="form-control" id="input-desa" placeholder="" value="<?php echo $data->desa ?>" autofocus>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" name="kecamatan" class="form-control" id="input-kecamatan" placeholder="" value="<?php echo $data->kecamatan ?>" autofocus>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" name="kabupaten" class="form-control" id="input-kabupaten" placeholder="" value="<?php echo $data->kabupaten ?>" autofocus>
